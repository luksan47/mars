...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-dark text-white">Game</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <table id="map"></table>
                    ...
                    <div class="col-md-4">
                        <div class="card-header bg-dark text-white">Players</div>
                        <div class="card-body" style="border:solid black 1px;">
                            ...
                            <div class="row justify-content-center"> <h3>Luksa Norbert</h3> </div>
                            <div class="row justify-content-center">
                                <button class="btn btn-success">Join game</button>
                            </div>
                            <div class="row justify-content-center">
                                <button class="btn btn-danger" href="{{ route('games.domino.create') }}">Create game</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-dark text-white">Blocks</div>
            <div class="card-body">
