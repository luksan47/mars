...
Route::middleware(['auth', 'log', 'verified'])->group(function () {
    ...
    Route::middleware(['can:print.modify'])->group(function () {
        ...
        Route::get('/secretariat/rooms', [SecretariatController::class, 'rooms'])->name('secretariat.rooms');
        Route::get('/secretariat/course', [SecretariatController::class, 'addCourseView'])->name('secretariat.course');
        Route::get('/secretariat/schedule', [SecretariatController::class, 'scheduleCourseView'])->name('secretariat.rooms.schedule');
        Route::post('/secretariat/schedule/send', [SecretariatController::class, 'scheduleCourse'])->name('secretariat.schedule.send');
        Route::post('/secretariat/course/add', [SecretariatController::class, 'scheduleCourse'])->name('secretariat.course.add');
    });
